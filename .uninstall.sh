...
rm "${XDG_DATA_HOME:-$HOME/.gitconfig}" "${XDG_DATA_HOME:-$HOME/.gitignore}" "${XDG_DATA_HOME:-$HOME/.skhdrc}" "${XDG_DATA_HOME:-$HOME/.taskrc}" "${XDG_DATA_HOME:-$HOME/.tool-versions}" "${XDG_DATA_HOME:-$HOME/.zshrc}" "${XDG_DATA_HOME:-$HOME/karabiner.edn}"
